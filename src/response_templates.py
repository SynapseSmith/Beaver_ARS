...
class Args:
    def __init__(self):
        ...
        # 표준 48개 인텐트 (main_ars_system.py와 동일)
        self.intents_dict = {
            0: "메뉴 카테고리 안내",
            1: "특정 상품 및 가격 안내",
            2: "상품에 대한 상세 및 추가 안내",
...
if __name__ == "__main__":
    ...
    # Portfolio 프로젝트 기준 상대 경로
    PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    data_path = os.path.join(PROJECT_ROOT, "data", "dataset_SQL_general_ju_1_105200_preprocessed.xlsx")
    dataframes = load_excel_to_dataframe(data_path)  
