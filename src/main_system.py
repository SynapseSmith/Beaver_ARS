...
log_folder = os.path.join('/home/user09/beaver/beaver_shared/data/shared_files/241219_BERT_NER/logs', date)
...
class Args:
    def __init__(self):
        ...
        self.model_checkpoint_path = "/home/user09/beaver/beaver_shared/data/shared_files/241218_NER/ner_checkpoint2"
        self.sim_threshold = 0.6
        self.output_dir = "/home/user09/beaver/beaver_shared/data/shared_files/241219_BERT_NER/checkpoint/klue_roberta_large_v9"
        self.data_path = "/home/user09/beaver/beaver_shared/data/shared_files/241219_BERT_NER/data/dataset_SQL_general_ju_6_hong_preprocessed.xlsx"
        ...
        self.response_templates = {
            ...
            4: [
                "개인적으로 {RECOMMEND_MENU} 메뉴를 {INDI_TYPE_NM1} 드립니다."
            ],
            5: [
                "저희 매장의 대표 메뉴는 {REPRE_MENU}이고, 이는 {INDI_TYPE_NM4} 메뉴로 인기 있어요."
            ],
            6: [  # 할인, 이벤트
                "현재 할인 중인 메뉴는 {EVENT_MENU}입니다."
            ],
            7: [  # 1+1
                "현재 {INDI_TYPE_NM7} 메뉴로 {PLUS_MENU}을 제공 중이에요."
                ],
            8: [
                "이번에 새로 나온 {INDI_TYPE_NM8}는 {NEW_MENU}입니다."
            ],
            9: [
                "저희 매장에서 {LIMIT_MENU} 메뉴는 {INDI_TYPE_NM6} 판매 중인 메뉴입니다."
            ],
            10: [
                "매운맛을 좋아하신다면 {SPICY_MENU} 메뉴를 추천드려요!"
            ],
            11: [
                "매장에서 {ORDER_CHNL_CD}를 통해 주문하실 수 있습니다."
            ],
            12: [
                "주문하신 상품은 {ORDER_TYPE} 방식으로 전달됩니다."
            ],
            13: [
                "저희 매장은 {PAYMNT_MN_CD} 방식으로 결제가 가능하며, 간편 결제로는 {EASY_PAYMNT_TYPE_CD}를 지원합니다."
            ],
            14: [
                "저희 매장에서는 {PAYMENT_NM_SPE} 결제 방식으로 {PAYMENT_AVAIL}"
            ],
            15: [
                "결제 관련 문의는 확인 후 다시 연락드릴게요."
            ],
            16: [
                "저희 매장은 {SALE_BGN_TM}부터 {SALE_END_TM}까지 영업합니다. 자세한 문의는 언제든 물어보세요."
            ],
            17: [
                "저희 매장은 {STORE_REST_BGN_TM}부터 {STORE_REST_END_TM}까지 브레이크 타임입니다."
            ],
            18: [
                "저희 매장의 휴무일은 {HOLIDAY_TYPE_CD}이며, 영업일은 {DAY_START}부터 {DAY_END}입니다."
            ],
            19: [
                "네, 운영합니다. 영업 시간은 {SALE_BGN_TM}부터 {SALE_END_TM}까지입니다."
            ],
            20: [
                "영업시간에 대한 자세한 문의는 확인 후 다시 연락드리겠습니다."
            ],
            21: [
                "저희 매장은 {DAY_NM}에 영업 {DAY_INFO}합니다. {SALE_BGN_TM}부터 {SALE_END_TM}까지 방문하실 수 있어요."
            ],
            22: [
                "반경 {DLVR_ZONE_RADS} 이내 지역에서 배달이 가능합니다."
                ],            
            23: [
                "저희 매장의 배달비는 최소 {DLVR_TIP_AMT}이며, 최소 주문 금액은 {ORDER_BGN_AMT}입니다."],
            24: [
                "배달 관련 문의는 확인 후 다시 연락드리겠습니다."
                ],
            25: [
                "현재 {ROOM_TABLE_ZONE_AVAIL}개의 테이블이 비어 있어요. 바로 이용하실 수 있습니다.",  # ---> if문!! "조금 기다리셔야 해요. 테이블 {ROOM_TABLE_ZONE_ENTIRE}개 모두 이용중이에요."
                ],
            26: [
                "테이블 이용에 대한 문의는 확인 후 다시 연락드리겠습니다."
                ],
            27: [
                "저희 매장 주소는 {ROAD_NM_ADDR}입니다. 참고하시라고 지도 링크를 보내드릴게요."
                ],
            28: [
                "더 정확히 안내드리기 위해 지도 링크를 보내드렸습니다."
                ],
            29: [
                "더 정확한 안내를 위해 지도 링크를 전송해드렸습니다."
                ],
            30: [
                "저희 매장은 총 {TABLE_NM}개의 테이블이 있으며, 최대 {MAX_PEOPLE}명까지 수용 가능합니다."
                ],
            31: [
                "저희 매장에는 단체석 및 예약석이 {TEAM_SEAT_YN}습니다. 예약을 원하시면 매장으로 연락 부탁드립니다."
                ],
            32: [
                "저희 매장에는 특별 좌석으로 룸 {ROOM_TABLE_ZONE_ENTIRE}개와 야외 좌석 {OUTDOOR_TABLE_ZONE_ENTIRE}개가 준비되어 있습니다."
                 ],
            33: [
                "시설 관련 문의는 확인 후 다시 연락드리겠습니다."
                 ],
            34: [
                "저희 매장은 멤버십 서비스를 제공하며, 포인트 적립 및 쿠폰 혜택을 위해 스마트 주문 앱 또는 키오스크를 통해 가입하실 수 있습니다."
                ],
            35: [
                "멤버십 가입 시 포인트 적립과 쿠폰 혜택을 받을 수 있습니다."
                ],
            36: [
                "구매 금액의 {POINT_BASE_ACCML_RATE}%가 포인트로 적립됩니다."
                ],
            37: [
                "저희 매장에서는 {USE_POSBL_BASE_POINT}점 이상의 포인트를 사용할 수 있습니다."
                ],
            38: [
                "스탬프 {STAMP_TMS}개 적립 시 {COUPON_PACK_NM}을 발급받으실 수 있습니다."
                ],
            39: [
                "{USE_MIN_ORDER_AMT}원 이상 구매 시 쿠폰을 사용할 수 있으며, 쿠폰은 현금처럼 사용 가능합니다."
                ],
            40: [
                "멤버십, 포인트 및 쿠폰 관련 문의는 확인 후 다시 안내드리겠습니다."
                ],
            41: [
                "현재 진행 중인 이벤트는 {EVENT_NM}입니다. 스마트주문 앱에서 더 자세히 확인하세요."
                ],
            42: [
                "현재 진행 중인 이벤트에 대한 자세한 정보는 스마트 주문 앱에서 확인할 수 있습니다. 앱 설치 링크를 전송해드렸으니 참고해주세요."
                ], 
            43: [
                "이벤트 관련 문의는 확인 후 다시 연락드리겠습니다."
                ],
            44: [
                "확인 후 다시 연락드리겠습니다."
                ],
            45: [
                "이용해 주셔서 감사합니다. 추가 문의가 있으면 언제든 연락주세요."
                ],
            46: [
                "안녕하세요! {STORE_NM}입니다. 어떤 문의를 도와드릴까요?" ## 상점명 들어갈 예정
                ],
            47: [
                "죄송합니다, 요청하신 정보를 바로 확인하기 어려워요."
                ]
            }
...
def execute_sql(intent_id, df):
    try:
        ...
        # 2번 --> 단순 탬플릿만으로 처리 가능
            ...
            result = df.query("INDI_TYPE_NM5 != '없음'")[['INDI_TYPE_NM5', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'POPULAR_MENU'})
            popular_menus = ", ".join(result['POPULAR_MENU'].tolist())
            return {"POPULAR_MENU": popular_menus, "INDI_TYPE_NM5": "인기"}
        elif intent_id == 4:    
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM1!= '없음'")[['INDI_TYPE_NM1', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'RECOMMEND_MENU'})
            recommend_menus = ", ".join(result['RECOMMEND_MENU'].tolist())
            return {"RECOMMEND_MENU": recommend_menus, "INDI_TYPE_NM1": "추천"}
        elif intent_id == 5:    
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM4!= '없음'")[['INDI_TYPE_NM4', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'REPRE_MENU'})
            represent_menu = ", ".join(result['REPRE_MENU'].tolist())
            return {"REPRE_MENU": represent_menu, "INDI_TYPE_NM4": "대표"}
        elif intent_id == 6:  
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM3!= '없음'")[['STORE_NM', 'INDI_TYPE_NM3', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'EVENT_MENU'}).sample(n=3, random_state=None)
            event_menu = ", ".join(result['EVENT_MENU'].tolist())
            return {"EVENT_MENU": event_menu, "INDI_TYPE_NM3": "이벤트"}
        elif intent_id == 7:  
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM7!= '없음'")[['INDI_TYPE_NM7', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'PLUS_MENU'})
            plus_menu = ", ".join(result['PLUS_MENU'].tolist())
            return {"PLUS_MENU": plus_menu, "INDI_TYPE_NM7": "1+1"}
        elif intent_id == 8:  
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM8!= '없음'")[['INDI_TYPE_NM8', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'NEW_MENU'})
            new_menu = ", ".join(result['NEW_MENU'].tolist())
            return {"NEW_MENU": new_menu, "INDI_TYPE_NM8": "신메뉴"}
        elif intent_id == 9:  
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM6!= '없음'")[['INDI_TYPE_NM6', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'LIMIT_MENU'})
            limit_menu = ", ".join(result['LIMIT_MENU'].tolist())
            return {"LIMIT_MENU": limit_menu, "INDI_TYPE_NM6": "한정"}
        elif intent_id == 10:  
            result = df.sample(frac=1, random_state=None).query("INDI_TYPE_NM2!= '없음'")[['INDI_TYPE_NM2', 'STD_PROD_NM']].rename(columns={'STD_PROD_NM': 'SPICY_MENU'})
            spicy_menu = ", ".join(result['SPICY_MENU'].tolist())
            return {"SPICY_MENU": spicy_menu, "INDI_TYPE_NM2": "매운맛"}
        elif intent_id == 11:  
        ...
        #     result = df.sample(frac=1, random_state=None).query("PAYMENT_NM_SPE!= '없음', PAYMENT_AVAIL!= '없음'")[['PAYMENT_NM_SPE', 'PAYMENT_AVAIL']].drop_duplicates()
            ...
            result = df.sample(frac=1, random_state=None).query("HOLIDAY_TYPE_CD!= '없음'")[['HOLIDAY_TYPE_CD', 'DAY_START', 'DAY_END']].drop_duplicates()
        elif intent_id == 19: 
            result = df.sample(frac=1, random_state=None).query("SALE_BGN_TM!= '없음' and SALE_END_TM!= '없음'")[['SALE_BGN_TM', 'SALE_END_TM']].drop_duplicates()
        # elif intent_id == 21: 
        ...
        elif intent_id == 46:   # USE_MIN_ORDER_AMT
            result = df.query("STORE_NM != '없음' and STORE_NM != ''")[['STORE_NM']].drop_duplicates()
        elif intent_id in [2, 15, 20, 24, 26, 28, 29, 33, 34, 35, 40, 42, 43, 44, 45, 47]:  # 고정 응답이 필요한 intent_id
...
holiday_info = {
    ...
    '화요일': {'영업여부': '안', '영업시작시간': '수요일에서 월요일 11시', '영업종료시간': '20시 30분'},
        ...
        if intent_id in [1, 14, 21]:
            ...
            if intent_id == 1:
                ...
                # 특정 결제 수단 안내: {PAYMENT_NM_SPE}, {PAYMENT_AVAIL}
                    ...
                    final_data = {"PAYMENT_NM_SPE": ner_entities[0][1], "PAYMENT_AVAIL": available}
                    final_data.update(result_data)  # SQL 결과 합치기
                    response_text = generate_response(intent_id, final_data)
