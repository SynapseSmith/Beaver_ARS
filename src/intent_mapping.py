...
file_path = os.path.join(PROJECT_ROOT, "data", "intent_v9.xlsx")  # 엑셀 파일 경로를 지정해주세요.
df = pd.read_excel(file_path)

# 표준 48개 인텐트 매핑 (main_ars_system.py와 동일)
intents_dict = {
            0: "메뉴 카테고리 안내",
            1: "특정 상품 및 가격 안내",
            2: "상품에 대한 상세 및 추가 안내",
...
# 수정된 엑셀 파일 저장
output_path = os.path.join(PROJECT_ROOT, "data", "user_intent_v4.csv")
