...
parser.add_argument("--data_path", type=str, required=True, help="Path to CoNLL format data")
...
train_entities, test_entities = train_test_split(df_entities, test_size=0.2, random_state=42)

# 엔티티가 없는 샘플을 80% 학습, 20% 평가로 분할
train_no_entities, test_no_entities = train_test_split(df_no_entities, test_size=0.2, random_state=42)
