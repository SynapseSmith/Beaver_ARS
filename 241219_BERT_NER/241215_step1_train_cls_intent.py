...
class Args:
    def __init__(self):
        ...
        self.output_dir = "/home/user09/beaver/beaver_shared/data/shared_files/241219_BERT_NER/checkpoint/klue_roberta_large_v9"  # klue_bert_base    klue_roberta_large
        self.file_path = "/home/user09/beaver/beaver_shared/data/shared_files/241219_BERT_NER/data/user_intent_v14.csv"

        # 데이터 관련 설정
        self.num_labels = 48  # 0~23까지 총 24개의 라벨
