...
class Args:
    def __init__(self):
        ...
        self.output_dir = "C:/Users/user/PycharmProjects/pythonProject/beaver/241215_BERT_XXXXXX/checkpoint/klue_roberta_large"  # klue_bert_base    klue_roberta_large
        self.file_path = "C:/Users/user/PycharmProjects/pythonProject/beaver/241215_BERT_XXXXXX/data/user_intent.csv"

        # 데이터 관련 설정
        self.num_labels = 22  # 0~21까지 총 22개의 라벨
