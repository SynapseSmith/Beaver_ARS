...
log_folder = os.path.join('C:/Users/user/PycharmProjects/pythonProject/beaver/241215_BERT_XXXXXX/logs', date)
    ...
    def __init__(self):
        ...
        self.response_templates = {
            0: [
                ...
                "저희 {STORE_NM}에는 {STD_CATEGORY_NM}와 같은 메뉴들이 있습니다. 자세한 내용은 메뉴판을 참조해주세요.",
                "{STORE_NM}에서는 {STD_CATEGORY_NM}와 같은 메뉴를 판매하고 있습니다."
            ],
            1: [
                "저희 {STORE_NM}에서 {RECOMMEND_MENU}가 {INDI_TYPE_NM1} 메뉴로서 인기가 많습니다.",
                 "{STORE_NM}에서 {INDI_TYPE_NM1} 메뉴로서 {RECOMMEND_MENU}을 추천드립니다.",
                "{STORE_NM}에서 고객님들이 가장 많이 찾는 메뉴는 {RECOMMEND_MENU} 입니다.",
            ],
            2: [
                "저희 매장에서 {INDI_TYPE_NM3} 메뉴로 {LIMMIT_MENU}가 있습니다.",
                "저희 {STORE_NM}에서는 {LIMMIT_MENU}를 {INDI_TYPE_NM3}로서 이벤트중입니다.",
                "지금 {STORE_NM}에서는 {INDI_TYPE_NM3} 메뉴인 {LIMMIT_MENU}를 만나보실 수 있습니다.",
                "저희 매장에서는 {INDI_TYPE_NM3} 메뉴로 {LIMMIT_MENU}를 특별 이벤트로 선보이고 있습니다."
            ],
            3: [
            ...
            4: [
                "저희 {STORE_NM}에서는 {PAYMNT_MN_CD}로 결제가 가능하며 간편결제로는 {EASY_PAYMNT_TYPE_CD}가 가능합니다.",
            ...
            12: [
                ...
                "{ROAD_NM_ADDR}에 오시면 {STORE_NM}을 찾으실 수 있습니다.",
...
def order():
    ...
    try:
        ...
        data_path = "C:/Users/user/PycharmProjects/pythonProject/beaver/241219_BERT_NER/data/dataset_SQL_general_ju_6_hong_preprocessed.xlsx"
