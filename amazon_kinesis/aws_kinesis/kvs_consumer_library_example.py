...
KVS_STREAM01_NAME = 'ju-connect-catholic-test-contact-5e7207f9-6866-476e-8380-b4346e77bc1c'   # Stream must be in specified region
...
if __name__ == "__main__":
    ...
    kvsConsumerExample.on_fragment_arrived(KVS_STREAM01_NAME, )
